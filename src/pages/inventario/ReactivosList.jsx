...
export default function ReactivosList() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xl font-bold" style={{ color: "#009933" }}>
                {totalReactivos}
              </p>
            </div>
          </div>
        ...
        >
          <div className="flex items-center gap-3">
            <div
              className="w-10 h-10 rounded-lg flex items-center justify-center"
              style={{
                backgroundColor: stockBajo.length > 0 ? "#FEF2F2" : "#F9F9F9",
              }}
            >
              <AlertTriangle
                className="w-5 h-5"
      ...
      {/* Filtros */}
      <div
        className="bg-white rounded-xl border p-4 shadow-sm flex flex-col sm:flex-row gap-4"
        style={{ borderColor: "#E5E5E5" }}
      >
