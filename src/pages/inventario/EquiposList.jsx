...
import RegistrarCalibracionModal from "../../components/inventario/RegistrarCalibracionModal";
...
export default function EquiposList() {
  ...
  const [showCalibracionModal, setShowCalibracionModal] = useState(false);
  const [equipoParaCalibracion, setEquipoParaCalibracion] = useState(null);
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center gap-1 ml-2">
                    ...
                    <button
                      onClick={() => {
                        setEquipoParaCalibracion(equipo);
                        setShowCalibracionModal(true);
                      }}
                      className="p-1.5 rounded-lg transition-all opacity-0 group-hover:opacity-100"
                      style={{ color: "#666666" }}
                      onMouseEnter={(e) => {
      ...
      <RegistrarCalibracionModal
        isOpen={showCalibracionModal}
        onClose={() => {
          setShowCalibracionModal(false);
          setEquipoParaCalibracion(null);
        }}
        equipo={equipoParaCalibracion}
        onSaved={loadEquipos}
      />
    </div>
  );
