    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Nuevo Reactivo" size="md">
      <div className="space-y-5">
        ...
        <div className="rounded-xl p-3 flex items-start gap-2" style={{ backgroundColor: "#E8F5E9", border: "1px solid #00993330" }}>
          ...
          <div>
            <p className="text-xs font-medium" style={{ color: "#009933" }}>Registro de nuevo reactivo</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              onBlur={(e) => { if (!errors.codigo) e.currentTarget.style.borderColor = '#E5E5E5'; e.currentTarget.style.boxShadow = 'none'; }}
            />
            {errors.codigo && (
              <p className="text-xs mt-1" style={{ color: '#DC2626' }}>{errors.codigo}</p>
            )}
          </div>
