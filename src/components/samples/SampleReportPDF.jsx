...
<View style={styles.infoRow}>
  ...
  <Text style={styles.infoValue}>{sample.clientAddress || "N/A"}</Text>
  <View style={[styles.infoRight, { minHeight: 100, justifyContent: "flex-end", padding: 5 }]}>
    <Text style={[styles.responsableText, { fontFamily: "Helvetica-Bold" }]}>
      {labInfo?.responsible}
    </Text>
    <Text style={styles.responsableSubText}>Responsable de los</Text>
    <Text style={styles.responsableSubText}>Laboratorios CABA - LAB</Text>
    <Text style={styles.responsableSubText}>Autorizado y revisado</Text>
  </View>
</View>
  ...
  <View key={analysis.id} wrap={false}>
    <Text style={styles.sectionTitle}>
      {analysis.service?.name?.toUpperCase()}
    </Text>
    ...
    <View style={styles.resultsTable}>
      ...
      <View style={styles.tableRow}>
        ...
        <Text style={styles.col}>
          {analysis.result?.resultNumber ?? analysis.result?.resultText ?? "N/A"}
        </Text>
        <Text style={styles.col}>
    ...
    <Text style={styles.metodoText}>
      ...
      {analysis.service?.code || "N/A"}
        ...
        <Text style={styles.footer}>
          {labInfo?.labName} — Informe generado el{" "}
          {formatDate(new Date())} — {sample.sampleCode}
        </Text>
